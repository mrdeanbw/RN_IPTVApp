        ...
        <Container style={GlobalStyle.viewConinater}>
            <Header style={styles.headerContainer}>
                ...
                <Body style={{flex: 3, alignItems: 'center'}}>
                    <Title style={GlobalStyle.headerTitle}>XMLTV Link
                    </Title>
                </Body>
                <Right style={{flex: 1}}>
                    <Button
            ...
            <Content>
                ...
                <View style={{marginBottom:15,marginTop:0, paddingLeft:10}}>
                    <Text style={{color:colors.placeholderTextColor, fontSize:14, borderBottomColor:colors.colorRed, borderBottomWidth:3}}>URL should return XMLTV content</Text>
                </View>
